...
/* ======================================================================================================
* Task for insert estiles en el adom-header-styles.html
* ======================================================================================================*/
gulp.task('styles-replace', ['styles'], function () {
    return gulp.src('./adom-header-styles.html')
        .pipe(replace(/<style>[^>]*<\/style>/, function (s) {
            var style = fs.readFileSync('./dist/css/adom-header.css', 'utf8');
            return '<style>\n' + style + '\n</style>';
        }))
        .pipe(gulp.dest('./'))
        .pipe(browserSync.stream());
...
gulp.task('serve', ['styles-replace', 'styles', 'watch'], function () {
    browserSync.init({
        injectChanges: true,
        files: ['./*.{html, scss}', './demo/index.html', './adom-header.js', './dist/css/adom-header.css'],
        server: "./",
    });
});

/* ======================================================================================================
* watch changes in files adom-header.scss and adom-header.html
* ======================================================================================================*/
gulp.task('watch', function () {
    gulp.watch('./adom-header.html', ['styles-replace']); // Vigila cambios en el html
    gulp.watch('./dist/css/adom-header.css', ['styles-replace']); // Vigila cambios en el html
